            ...
            <div className="relative">
              <div className="w-full h-96 bg-gradient-to-br from-blue-600 to-blue-900 rounded-2xl shadow-2xl overflow-hidden">
                <div className="absolute inset-0">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-blue-900/90 via-blue-900/40 to-blue-900/10"></div>
                </div>
          ...
          <div className="bg-gray-800/50 rounded-2xl p-8 shadow-2xl border border-gray-700">
            ...
            <div className="mt-8 pt-8 border-t border-gray-700">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-6">
                <a href="mailto:josephjelasker@gmail.com" className="flex items-center hover:text-blue-400 transition-colors">
                  <svg className="w-5 h-5 text-blue-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <span className="text-gray-300 hover:text-blue-400 transition-colors">josephjelasker@gmail.com</span>
                </a>
                <a href="https://linkedin.com/in/josephjelaskar" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-blue-400 transition-colors">
                  <svg className="w-5 h-5 text-blue-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" />
                  </svg>
                  <span className="text-gray-300 hover:text-blue-400 transition-colors">linkedin.com/in/josephjelaskar</span>
                </a>
              </div>
            </div>
          </div>
